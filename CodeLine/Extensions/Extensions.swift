...
@IBDesignable class DesignableButton: UIButton {
    ...
    func setUpView() {
        ...
        self.substituteFontName = HelpingMethods.FontBasedOnLanguage()// "Montserrat"
    }
}
...
@IBDesignable class DesignableUITextField: UITextField {
    ...
    func setUpView() {
        ...
        self.substituteFontName = HelpingMethods.FontBasedOnLanguage()
    }
}
...
extension UILabel {
    public var substituteFontName : String {
        get {
            ...
            self.font = UIFont(name: fontName, size: UIDevice.current.userInterfaceIdiom == .phone ? self.font.pointSize : self.font.pointSize + CGFloat(Constants.FONT_SIZE_CONSTANT_iPad))
        }
    }
}
...
extension UIButton {
    public var substituteFontName: String {
        get {
            ...
            self.titleLabel!.font = UIFont(name: fontName, size: UIDevice.current.userInterfaceIdiom == .phone ? self.titleLabel!.font.pointSize : self.titleLabel!.font.pointSize + CGFloat(Constants.FONT_SIZE_CONSTANT_iPad))
        }
    }
}
...
extension UITextView {
    public var substituteFontName : String {
        get {
            ...
            self.font = UIFont(name: fontName, size:  UIDevice.current.userInterfaceIdiom == .phone ? self.font?.pointSize ?? 17 : (self.font?.pointSize ?? 17) + CGFloat(Constants.FONT_SIZE_CONSTANT_iPad))
        }
    }
}
