...
class ContactsViewController: UIViewController {
    ...
    func registerNibFiles()
    {
        ...
        tv.register(UINib(nibName: ContactTableViewCell.identifier(), bundle: nil), forCellReuseIdentifier: ContactTableViewCell.identifier())
    }
    func setImages()
    {
        for i  in 0...11 {
    ...
    @IBAction func actionOfbtnNew(_ sender: Any) {
        let projectDetailsViewController  = GroupViewController(nibName: "GroupViewController", bundle: nil)
